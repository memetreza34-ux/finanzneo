...
```text
S03 | FN_ACCOUNT_TRANSFER | Geldschein | Giro → Depot | links→rechts | Zielsaldo steigt
S06 | FN_COST_EXTRACTION | Rechnung | Betrag wird reduziert | horizontal+fall | Restbetrag
```
...
- neue eindeutige `MECHANIC_ID` mit Präfix `FN_`
