...
- Numbering is authoritative: `Bild 00` = cover, `Bild 01` = scene 01, `Bild 02` = scene 02, and so on.
...
- When Antigravity generates images, save the finals first into `BILDER-EINGANG` with the correct numbers and then use the same sorter.
