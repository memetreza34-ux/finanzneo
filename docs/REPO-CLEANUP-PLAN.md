...
- `CLAUDE.md` als einzige verbindliche Quelle
- Primärformat auf 60–90 Sekunden vertikal umstellen
- Untertitel verpflichtend machen
- neuen Premium-isometrischen Erklärbildstil festlegen
- Safe Areas oben und unten festschreiben
- Monetarisierungsweg PDF → Leads → Affiliate dokumentieren
- alte widersprüchliche Anleitungen ersetzen

## Phase 2 — Produktionssicherheit

- ein einziges Caption-Datenformat definieren
- Caption-Generator und React-Komponenten angleichen
- fehlende Audio- und Caption-Dateien mit verständlichen Fehlern behandeln
- Assets vor dem Build validieren
- keine produktive Komposition darf auf nicht versionierte Pflichtdateien zeigen
...
1. Caption-Format stimmt nicht zwischen Generator und Short-Komponente überein
2. Pflicht-Caption-Dateien werden ignoriert, aber direkt importiert
...
5. Dokumente enthalten widersprüchliche Disclaimer-, Untertitel- und Formatregeln
