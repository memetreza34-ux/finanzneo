...
const STYLE_BLOCK = `FINANZNEO_WORLD_ID: ${WORLD_ID}\n\nVERBINDLICHER BILDSTIL:\nPremium fintech editorial 3D render style. Background is deep charcoal green-black. Accents in vivid emerald and mint green. Gold only for euro coins, cash and financial value. Warm red-orange only for loss, debt, danger or blocked money. Use smooth rounded 3D geometry, soft bevelled edges, premium matte and glass materials, confident high-contrast studio lighting with bold emerald rim light.\n\nVISUAL LANGUAGE:\nUse ONE dominant visual metaphor and only a few supporting elements. A stylized anonymous 3D adult person may stand beside the metaphor when it improves clarity. Never use a photorealistic or identifiable real human.\n\nTEXT RULE:\nNo headline. No subtitle. No explanatory sentence. Only 1–3 short German object labels, directly near the objects they describe, small to medium sized, clean sans-serif, white or light gray.\n\nCOMPOSITION LOCK:\nVertical 9:16. Top 15 percent must be completely empty dark negative space. Bottom 25 percent must be completely empty dark uncluttered negative space. Keep the full visual story inside the middle 60 percent.\n\nFORBIDDEN:\nNo photorealism, no real humans, no UI dashboard, no app screen, no tiny isometric diorama, no neon tunnel, no sci-fi corridor, no miniature game level, no clutter, no giant typography, no full sentence, no random labels, no Pixar, no clay.\n`;
...
const imagePrompt = (id, index) => `${flowInstruction(sceneFileName(index))}\n${STYLE_BLOCK}\nBESCHRIFTUNGEN – EXAKT SO:\n- [KURZES DEUTSCHES OBJEKT-LABEL]\n- [OPTIONALES ZWEITES KURZES LABEL]\n\nBILDPROMPT:\nA stylized 3D adult person standing beside [ONE LARGE DOMINANT VISUAL METAPHOR FOR ${id}]. [DESCRIBE CLEAR CAUSE AND EFFECT USING ONLY A FEW LARGE OBJECTS]. Include German object labels: [PLACE EACH SHORT LABEL DIRECTLY BESIDE THE RELEVANT OBJECT]. Premium fintech editorial 3D render style. Background is deep charcoal green-black. Accents in vivid emerald and mint green. Gold only for money/value and warm red-orange only for danger/loss. Use smooth rounded 3D geometry, soft bevelled edges, premium materials, confident high-contrast studio lighting with bold emerald rim light. Ensure the top 15 percent is completely empty dark negative space and the bottom 25 percent is completely empty uncluttered negative space. Vertical 9:16. No photorealism, no real human, no UI dashboard, no headline, no subtitle, no explanatory sentence, no tiny diorama, no neon tunnel, no sci-fi corridor.\n`;

const coverPrompt = `${flowInstruction('Bild 00 - [KURZER COVER-NAME].png')}\n${STYLE_BLOCK}\nCOVER-REGEL:\nKeine klassische Überschrift. Thema über EIN starkes Hauptmotiv + wenige kurze Objekt-Beschriftungen erklären.\n\nBESCHRIFTUNGEN – EXAKT SO:\n- [THEMA ALS KURZES OBJEKT-LABEL]\n- [OPTIONALE KURZE STRUKTUR-LABELS]\n\nBILDPROMPT:\nA stylized 3D adult person standing beside [ONE LARGE DOMINANT COVER METAPHOR]. [SHOW THE CORE IDEA OF THE REEL IN ONE CLEAR VISUAL]. Include only the specified short German object labels directly beside their objects. Premium fintech editorial 3D render style. Background is deep charcoal green-black. Accents in vivid emerald and mint green. Gold only for money/value and warm red-orange only for danger/loss. Use smooth rounded 3D geometry, soft bevelled edges, premium materials, confident high-contrast studio lighting with bold emerald rim light. Ensure the top 15 percent is completely empty dark negative space and the bottom 25 percent is completely empty uncluttered negative space. Vertical 9:16. No photorealism, no real human, no UI dashboard, no headline, no subtitle, no explanatory sentence, no tiny diorama, no neon tunnel, no sci-fi corridor.\n`;

const worldPrompt = `FINANZNEO WORLD REFERENCE\n\nFINANZNEO_WORLD_ID: ${WORLD_ID}\n\nPremium fintech editorial 3D render style. Deep charcoal green-black background, vivid emerald and mint accents, gold for money/value, warm red-orange for danger/loss. Smooth rounded 3D geometry, soft bevelled edges, premium matte/glass materials, confident high-contrast studio lighting with bold emerald rim light. A stylized anonymous 3D adult person may stand beside one dominant financial metaphor. No photorealism, no real human, no UI dashboard, no tiny diorama, no neon tunnel, no sci-fi corridor. Text style: only 1–3 short German object labels near their objects, never a headline/subtitle/sentence. Top 15% completely empty dark negative space; bottom 25% completely empty dark uncluttered negative space; all visual content in middle 60%.\n`;
...
write('03-szenen/README.md', '# SZENEN\n\nGoogle Flow: 1 Bild erzeugen → sofort umbenennen → Motiv + kurze deutsche Objekt-Labels prüfen → erst dann nächstes Bild. Bildstil: Premium Fintech Editorial 3D, eine starke Metapher, optional stylisierte 3D-Person, oben 15 % leer, unten 25 % leer.\n');
...
write('03-szenen/scene-index.json', `${JSON.stringify({
  ...
  imageWorld:{id:WORLD_ID,style:'premium-fintech-editorial-3d-metaphor',stylizedPersonAllowed:true,objectLabelsOnly:true,topNegativeSpace:0.15,bottomNegativeSpace:0.25,headlinesInGeneratedImagesForbidden:true,subtitlesInGeneratedImagesForbidden:true,sentencesInGeneratedImagesForbidden:true,tinyDioramaForbidden:true,neonTunnelForbidden:true},
...
console.log('  Bilder: Premium Fintech Editorial 3D · eine starke Metapher · kurze deutsche Labels · 15% oben/25% unten leer');
