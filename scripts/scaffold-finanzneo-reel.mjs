...
write('03-szenen/scene-index.json', `${JSON.stringify({
  ...
  subtitleDisplay:{mode:REEL_CAPTION.mode,activeWordColor:REEL_CAPTION.activeWordColor,maxWords:REEL_CAPTION.maxWords,maxCharacters:REEL_CAPTION.maxCharacters,maxLines:REEL_CAPTION.maxLines,singleLineMaxCharacters:REEL_CAPTION.singleLineMaxCharacters,maxCharactersPerLine:REEL_CAPTION.maxCharactersPerLine,fontSize:REEL_CAPTION.fontSize,noDeadGaps:true,holdDuringPauses:REEL_CAPTION.holdDuringPauses,noWordJump:REEL_CAPTION.noWordMotion,noWordScale:REEL_CAPTION.noScaleAnimation},
  layout:REEL_LAYOUT,
...
console.log(`  Abschlussprüfung: npm run reel:final -- ${targetArg}`);
