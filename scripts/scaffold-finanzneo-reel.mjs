...
const flowInstruction=(fileName)=>`GOOGLE FLOW – FINALER DATEINAME:\n\`${fileName}\`\n\nWICHTIG:\nErzeuge GENAU EIN vertikales 9:16-Bild. Danach SOFORT exakt wie oben umbenennen, Motiv + Beschriftungen + Gesicht (falls Person) + nahtlosen Hintergrund + Dateiname prüfen und erst dann das nächste Bild erzeugen. Der Dateiname selbst darf NICHT sichtbar im Bild erscheinen.\n`;
