...
write('README.md', `# ${title}\n\nEinfache Struktur:\n- 01-script = Fließtext fürs Voiceover\n- 02-audio = fertiges Audio\n- 03-szenen = Cover, Bildprompts, Szenen, fertige Nutzerbilder\n- 04-caption = Master-Caption, Reel-Plattformtexte und Wort-Timings\n- 05-projektdateien = Animationen, Recherche, Technik\n- 06-export = fertiges Upload-Paket\n\n3 Phasen:\n1. Phase 1 erstellt Recherche, Skript, Bildprompts UND jede Remotion-Animation als fertige animation.tsx.\n2. Nutzer erstellt Flow-Bilder + finales Audio + Wortzeiten.\n3. Executor integriert exakt die versiegelten Phase-1-Animationsquellen und rendert erst nach Preflight/QA.\n\nV5: Header Y154, Visual Y320–1480, Caption bottom340. Header = normaler Text + einfaches Icon, keine Capsule.\n`);
...
write('03-szenen/README.md', '# SZENEN\n\nV5: Jede Szene bekommt einen normalen mittigen Header aus natürlichem Text + passendem Linien-Icon. Keine Capsule/Chip/Pill, kein erzwungenes ALL CAPS. Header Y154, Visual Y320–1480, Caption bottom340. Bildszenen besitzen bildprompt.txt; Animationsszenen besitzen remotion.md UND eine in Phase 1 vollständig fertigzustellende animation.tsx.\n');
