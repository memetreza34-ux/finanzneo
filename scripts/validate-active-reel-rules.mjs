...
const requiredMarkers = new Map([
  ...
  ['scripts/apply-future-image-storytelling-v5-hardening.mjs', ['finanzneo-image-storytelling-v5-hardening-v1', 'compiledDirectionInsideImagePromptRequired', 'minDistinctCameraAnglesPerSixImages', 'LABEL_BUDGET']],
  ...
  ['scripts/validate-future-image-storytelling-v5-hardening.mjs', ['finanzneo-image-storytelling-v5-hardening-v1', 'minDistinctCameraAnglesPerSixImages', 'V5_COMPILED_DIRECTION', 'TABLE_DOCUMENT_SCENE=false']],
  ['scripts/lib/image-storytelling-v5-hardening.mjs', ['V5_COMPILED_DIRECTION_START', 'LOCATION_CLASSES', 'LIGHTING_VARIATIONS', 'buildCompiledDirection']],
