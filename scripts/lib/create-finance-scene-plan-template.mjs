...
export const createFinanceScenePlanTemplate = ({slug = 'thema-slug', title = 'FinanzNeo-Reel', topic = 'Finanzthema'} = {}) => {
  const scenes = [
    ...
    {
      id: 'cta', durationSec: 4,
      voiceText: 'FINANCE_TODO_SCRIPT: Kommentar-Keyword und konkreten kostenlosen Nutzen nennen.',
      layout: 'cta', variant: 'default', purpose: 'Eine klare Handlung auslösen.',
      visualAction: 'Das letzte Bild läuft ruhig weiter; Überschrift, Icon, Keyword und Untertitel liegen darüber.',
      visualPhases: singlePhase('CTA auf dem letzten Bild zeigen'),
      semanticChanges: ['statischer CTA'], assetIds: [],
      content: {icon: 'document', kicker: 'FINANCE_TODO_CONTENT', headline: 'FINANCE_TODO_CONTENT', ctaKeyword: 'AUSFÜLLEN', ctaBenefit: 'FINANCE_TODO_CONTENT'},
      transition: 'cut', decorativeOnly: false,
    },
  ];
