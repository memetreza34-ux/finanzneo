...
export { Typewriter, MaskReveal, WordStagger, Underline, Scramble, KineticPunch, FlipIn3D, WaveText } from './components/TextFX';
...
export { SentenceKaraokeCaptions, Captions, CaptionsBoxed } from './components/Captions';
export type { CaptionSentence, CaptionWord } from './components/Captions';
