...
- Kein vorheriges Bild als Referenz verwenden; jeder Prompt enthält den vollständigen stylized-3D-Lock.
- Bilder strikt einzeln erzeugen, sofort umbenennen und prüfen.
- Alle finalen Bilder gemeinsam nach `00-ALLE-BILDER-HIER-REIN/` legen.
- Flow-Quellen immer 1:1.
- Bildbeat ideal 3,5–5,0 s, absolut maximal 6,0 s; wenn länger nötig: splitten oder animieren.
